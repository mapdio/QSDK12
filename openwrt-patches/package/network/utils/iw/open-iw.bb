...
DEPENDS += "libnl"
TARGET_CFLAGS = " -fpie -Wall -Werror -O2 -Wno-sign-compare -Wno-unused-variable -Wno-unused-function -Wno-error=switch "
TARGET_LDFLAGS = "-pie"
EXTRA_OEMAKE = ""
...
do_patch() {
	ls ${THISDIR}/../iw-patches | xargs -I % sh -c 'echo "applying patch "%;patch -d${S} -f -p1 < ${THISDIR}/../iw-patches/%'
	ls ${THISDIR}/patches | xargs -I % sh -c 'echo "applying patch "%;patch -d${S} -f -p1 < ${THISDIR}/patches/%'
}
